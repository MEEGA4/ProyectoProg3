...
public class VentanaProductosTabla extends JFrame {
    ...
    public VentanaProductosTabla(List<String> titulos, List<Producto> productos, GestorBD gestorBD, Trabajador trabajador) {
        ...
        JLabel lblTituloVentana = new JLabel("GESTIÓN DE PRODUCTOS");
        ...
        panelPrincipal.addKeyListener(keyAdapter); // Listener al panel principal también
        setFocusable(true);
        ...
        this.addWindowListener(new WindowAdapter() {
            ...
            public void windowClosing(WindowEvent windowEvent) {
                // No cerramos BD aquí para mantener la conexión en la ventana padre
            }
        });
